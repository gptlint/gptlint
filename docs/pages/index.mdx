...
- ✅️ simple markdown format for rules ([example](https://github.com/gptlint/gptlint/tree/main/.gptlint/prefer-array-at-negative-indexing.md), [spec](./extend/rule-spec.md))
