...
| free                         | [expensive](./cost.md) or [cheap using local LLMs](./guide/llm-providers.md#local-models) |
| low-impact                   | **high-impact**                                                                           |

So what does a higher-level linting rule look like, and when should you use an AST-based linting rule versus an LLM-based linting rule? We answer this in-depth in our [rule guidelines](./guide/rule-guidelines.md), but the short answer is that we recommend using deterministic, AST-based linting wherever possible and augmenting this AST-based linting with LLM-based linting and code reviews to provide a _defense-in-depth approach to code quality_.

### What about fine-tuning?

See our notes on [fine-tuning in how it works](./guide/how-it-works.md#fine-tuning).
