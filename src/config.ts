...
export const RuleDefinitionExampleSchema = z.object({
...
export const RuleDefinitionSchema = z.object({
  ...
  postProcessFile: z
    ...
    .optional()
    .describe(
      'Optional post-processing linter logic specific to this rule. Will be run after the built-in post-processing logic. Very useful for customizing the linting results in a rule-specific way such as pruning common false positives.'
    )
})
